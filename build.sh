...
if [ "$py" == "yes" ]; then
    ...
    cmd="python3 comboplayer.py"
    #cmd="python3 aggr_agent.py"
	echo "PY3"
elif [ "$cpp" == "yes" ]; then
	g++ -O2 *.cpp -o exe
	cmd="./exe"
...
prefix="./"
ta_agent=("manual_player")
#ta_agent=("random_player")
#ta_agent=("aggr_agent")
#ta_agent=("my_player5") # For against Aman
#ta_agent=("self_player")
surfix=".py"
...
do
    ...
    echo =====Summary=====  
    echo "You play as Black Player | Win: $black_win_time | Lose: $((play_time-black_win_time)) | Tie: $black_tie"
    echo "You play as White Player | Win: $white_win_time | Lose: $((play_time-white_win_time)) | Tie: $white_tie"
done
